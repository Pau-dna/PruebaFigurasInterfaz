 ...
 */
 ...
 /**
 * Metodo que calcula y devuelve el area de un rectangulo como la multiplicacion de la base por la altura 
 ...
 */
 ...
 /**
 * Metodo que calcula y devuelve el perimetro de un rectangulo como (2 * base) + (2 * altura) 
